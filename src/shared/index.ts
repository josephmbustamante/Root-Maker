...
const NUMBER_SUFFIX_MAPPINGS = [
  { number: 1000000, suffix: 'Mil' },
  { number: 1000000000, suffix: 'Bil' },
  { number: 1000000000000, suffix: 'Tril' },
  { number: 1000000000000000, suffix: 'Quad' },
  { number: 1000000000000000000, suffix: 'Quin' },
  { number: 1000000000000000000000, suffix: 'Sext' },
  { number: 1000000000000000000000000, suffix: 'Sept' },
  { number: 1000000000000000000000000000, suffix: 'Oct' },
  { number: 1000000000000000000000000000000, suffix: 'Non' },
  { number: 1000000000000000000000000000000000, suffix: 'Dec' },
